			...
			while (_la==ID) {
				...
				while (_la==T__25) {
					...
					((RecordFieldsContext)_localctx).ID2 = match(ID);
					                       ...
					                       for(RecordField rf: _localctx.ast)
					                       {
					                           if(rf.getName().equals((((RecordFieldsContext)_localctx).ID2!=null?((RecordFieldsContext)_localctx).ID2.getText():null)))
					                           {
					                               new ErrorType("Variable in struct with name " + (((RecordFieldsContext)_localctx).ID2!=null?((RecordFieldsContext)_localctx).ID2.getText():null) + " is already defined",
					                                              ((RecordFieldsContext)_localctx).ID2.getLine(),((RecordFieldsContext)_localctx).ID2.getCharPositionInLine()+1);
					                               repeated2 = true;
					                               break;
					                           }
					                       }
				...
				match(T__27);
				  for(String id: _localctx.ids){
				                            _localctx.ast.add(new RecordField(id, ((RecordFieldsContext)_localctx).type.ast,
				                                ((RecordFieldsContext)_localctx).ID1.getLine(),((RecordFieldsContext)_localctx).ID1.getCharPositionInLine()));
				                        }
				                        ((RecordFieldsContext)_localctx).ids =  new ArrayList<String>();
